...
如果你是第一次接触 VCPToolBox，建议先阅读下面这份新手手册，再回到专题文档深挖：

| 文档 | 描述 |
|------|------|
| [BEGINNER_MANUAL.md](./BEGINNER_MANUAL.md) | 面向普通用户和轻运维用户的超详细中文入门手册，覆盖启动、登录、API 接入、AdminPanel 全页面图解、插件启停、RAG、VCPChrome、OpenWebUI、SillyTavern 与高频故障排查 |
...
| [OPENCLAW_INTEGRATION.md](./OPENCLAW_INTEGRATION.md) | OpenClaw 与 VCP 的工具、记忆、知识问答、镜像落盘、VCPChat 可视化链路 | ⭐⭐⭐ |
...
| 理解 OpenClaw 如何接 VCP | [OPENCLAW_INTEGRATION.md](./OPENCLAW_INTEGRATION.md) |
